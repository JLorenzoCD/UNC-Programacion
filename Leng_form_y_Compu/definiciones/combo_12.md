...
- Si $(\overrightarrow{x}, \overrightarrow{\alpha}) \in S$, entonces $\mathcal{P}$ se detiene partiendo desde $|| x_1, \cdots, x_n, \alpha_1, \cdots, \alpha_m ||$ y la variable N1 queda con contenido igual a 1.
- Si $(\overrightarrow{x}, \overrightarrow{\alpha}) \notin S$, entonces $\mathcal{P}$ se detiene partiendo desde $|| x_1, \cdots, x_n, \alpha_1, \cdots, \alpha_m ||$ y la variable N1 queda con contenido igual a 0.
