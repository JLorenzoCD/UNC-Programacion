...
static char *is_alive_str(bool alive) {
  return (alive) ? "Yes" : "No";
}
...
Character character_create(char ctype, char alignment, char *name, unsigned int life, unsigned int strength, unsigned int agility) {
